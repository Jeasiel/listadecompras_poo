...
public class Organizador {
    ...
    public Organizador(){
        //Caso não precise, apagar
    }

    public void menuDaLista(Lista lista){
        //Esse usaremos como teste no terminal
        Scanner scanner = new Scanner(System.in);
        //Aqui estará a classe do menu principal com as funções <- Editar depois
        if(lista == null){
            lista = new Lista("Lista Exemplo", "Mercado");
        }
